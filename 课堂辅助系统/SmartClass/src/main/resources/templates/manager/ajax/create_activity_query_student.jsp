...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/manager/";
%>
<script type="text/javascript" src="<%=basePath%>js/ajax_create_activity_query_student.js"></script>
	...
	<table class="show-table-appoint control-name-width">
		...
		<s:iterator value="studentPOList" status="st">
			<tr class="show-tr-min student-tr-js">
				<td><s:property value="%{#st.count+(pageVO.nowPage-1)*pageVO.pageSize}" /></td>
				<td><s:property value="college" /></td>
				<td><s:property value="grade" /></td>
				<td><s:property value="profession" /></td>
				<td sid="<s:property value="sid" />"><s:property value="sno" /></td>
				<td><s:property value="sname" /></td>
				<td><span class="glyphicon glyphicon-ok left-margin operate operate-min" onclick="addStatisticsManager(this)"></span></td>
			</tr>
		</s:iterator>
	</table>
	<ul class="input-ul">
