...
public class HttpUtils {
	public static final String BASE_URL = "http://192.168.1.100:8080/SmartClass/";
	public static final String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/smartclass";
	...
	// 获得Get请求对象request
		...
		public static String uploadFile(String filename) {
			...
			try {
				URL url = new URL(HttpUtils.BASE_URL + "UpPhotoServlet");
				...
				File file = new File(HttpUtils.FILE_PATH + "/" + filename);
