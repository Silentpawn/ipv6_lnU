...
<!--实验结果：<input class="input-text" style="width:100px;vertical-align:middle;" id="leadership" name="leadership"><br>
实验材料：<input class="input-text" style="width:100px;vertical-align:middle;" id="teamwork" name="teamwork"><br>
