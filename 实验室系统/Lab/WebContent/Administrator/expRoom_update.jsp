...
<div class="page-container">
	<form class="form form-horizontal" name="form-change-pwd" method="post" action="${pageContext.request.contextPath}/expRoom/update" > 
	 
	<input type="hidden" name="erid" value="${expRoom.erid}"/>	
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="${expRoom.eraddress }" name="eraddress" placeholder="请输入位置"  class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						联系方式：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="${expRoom.ertelnum }" name="ertelnum" placeholder="请输入联系方式"  class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						状态：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="${expRoom.erstate }" name="erstate" placeholder="请输入状态"  class="input-text">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						分院：</label>
					<div class="formControls col-xs-8 col-sm-9">
					<select class="form-control" name="superordinate" >
