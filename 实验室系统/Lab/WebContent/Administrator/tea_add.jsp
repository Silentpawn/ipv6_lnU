...
<div class="page-container">
	<form class="form form-horizontal" name="form-change-pwd" method="post" action="${pageContext.request.contextPath}/tea/insert" > 
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="teacherNumber" placeholder="请输入工号"  class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						手机：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="phoneNumber" placeholder="请输入手机"  class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						部门：</label>
					<!--  <div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="department" placeholder="请输入部门"  class="input-text">
					</div>-->
