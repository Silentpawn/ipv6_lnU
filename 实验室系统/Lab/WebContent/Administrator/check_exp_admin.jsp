...
<script language="javascript">
	...
	function getExpApplication()
	{
		...
		var loader=new net.AjaxRequest("../AdministratorServlet?action=check_expCourse_application&nocache="+new Date().getTime(),deal_getExpApplication,onerror,"POST",encodeURI(param));
	}
	function onerror(){
		alert("您的操作有误！");
	}
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 实验课程管理 <span class="c-gray en">&gt;</span>实验审核 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">

	<div class="cl pd-5 bg-1 bk-gray mt-20" >
	    <span class="r" id="count_num"></span> 
...
<script type="text/javascript">
	...
	function consent_application(){
		...
		var loader=new net.AjaxRequest("../AdministratorServlet?action=consent_application&nocache="+new Date().getTime(),deal_consent_application,onerror,"POST",encodeURI(param));
	}
	...
	function deny_application(){
		...
		var loader=new net.AjaxRequest("../AdministratorServlet?action=deny_application&nocache="+new Date().getTime(),deal_deny_application,onerror,"POST",encodeURI(param));
	}
